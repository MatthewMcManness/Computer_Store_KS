    ...
    return (
      <div className="rounded-lg border border-gray-200 bg-white">
        <div className="p-8 text-center">
          ...
          <p className="mt-4 text-gray-600">Loading computers...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="rounded-lg border border-gray-200 bg-white">
        <div className="p-8 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900">No computers found</h3>
          <p className="mt-1 text-gray-500">Get started by adding your first computer.</p>
          <Link
          ...
          {computers.map((computer) => (
            <tr
              ...
              className={cn(
                ...
                selectedId === computer.id && 'bg-purple-50'
              )}
            >
              ...
              <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">
                {computer.blackFriday?.enabled ? (
                  <div>
                    ...
                    <span className="ml-2 text-red-600">{computer.blackFriday.salePrice}</span>
                  </div>
                ) : (
                  computer.price
                )}
