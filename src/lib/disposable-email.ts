 ...
 *
 * Detects temporary/disposable email addresses commonly used by spammers.
...
const DISPOSABLE_DOMAINS = new Set([
  ...
  'emailondeck.com', 'email-fake.com',
  'mohmal.com', 'mohmal.im',
  'minutemail.com', 'mintemail.com',
  'mytemp.email', 'mytempmail.com',
  'inboxalias.com', 'incognitomail.com',
  'burnermail.io', 'burnmail.com',

  // Common variations
  '10mail.org', '10mail.tk', '10minmail.com',
  '20minutemail.com', '20minutemail.it',
  '33mail.com', '3mail.ga',
  'anonymbox.com', 'anonymmail.net',
  'antispam.de', 'antispam24.de',
  'armyspy.com', 'anonbox.net',
  'binkmail.com', 'bobmail.info',
  'bofthew.com', 'boximail.com',
  'bugmenot.com', 'bumpymail.com',
  'casualdx.com', 'centermail.com',
  'cheatmail.de', 'choicemail1.com',
  'cool.fr.nf', 'correo.blogos.net',
  'cosmorph.com', 'courriel.fr.nf',
  'courrieltemporaire.com', 'curryworld.de',
  'cuvox.de', 'dacoolest.com',
  ...
  'einmalmail.de', 'email60.com',
  'emaildienst.de', 'emailgo.de',
  ...
  'flyspam.com', 'fr33mail.info',
  'frapmail.com', 'friendlymail.co.uk',
  'front14.org', 'fuckingduh.com',
  'fudgerub.com', 'garliclife.com',
  'gehensiull.com', 'get1mail.com',
  ...
  'klassmaster.net', 'klzlv.com',
  'kook.ml', 'kulturbetrieb.info',
  'kurzepost.de', 'lawlita.com',
  'lazyinbox.com', 'letthemeatspam.com',
  'lhsdv.com', 'lifebyfood.com',
  'link2mail.net', 'litedrop.com',
  'liveradio.tk', 'loadby.us',
  'login-email.ml', 'lol.ovpn.to',
  ...
  'maildrop.cf', 'maildrop.ga',
  'maildrop.gq', 'maildrop.ml',
  'maildu.de', 'maildx.com',
  ...
  'mailinater.com', 'mailinator.co.uk',
  'mailinator.info', 'mailinator.us',
  ...
  'monumentmail.com', 'ms51.hinet.net',
  'msb.minsmail.com', 'msgos.com',
  'mspeciosa.com', 'mswork.ru',
  'mt2009.com', 'mt2014.com',
  'myalias.pw', 'mycleaninbox.net',
  'myemailboxy.com', 'mymail-in.net',
  'mymailoasis.com', 'mynetstore.de',
  'mypacks.net', 'mypartyclip.de',
  'myphantomemail.com', 'myspaceinc.com',
  ...
  'quickmail.nl', 'rainmail.biz',
  'rcpt.at', 're-gister.com',
  'reallymymail.com', 'realtyalerts.ca',
  'recode.me', 'reconmail.com',
  'recursor.net', 'recyclemail.dk',
  'regbypass.com', 'regbypass.comsafe-mail.net',
  'rejectmail.com', 'remail.cf',
  'remail.ga', 'rhyta.com',
  ...
  'server.ms.selfip.net', 'sharedmailbox.org',
  'sharklasers.com', 'shieldemail.com',
  'shiftmail.com', 'shitmail.me',
  'shortmail.net', 'shut.name',
  'shut.ws', 'sibmail.com',
  'sinnlos-mail.de', 'siteposter.net',
  'skeefmail.com', 'slaskpost.se',
  'slave-auctions.net', 'slopsbox.com',
  'slowslow.de', 'slushmail.com',
  ...
  'tellos.xyz', 'temp.emeraldwebmail.com',
...
/**
 * Get spam score for disposable email
 *
 * @param email - Email address to check
 * @returns Spam score (0 or 25)
 */
export function getDisposableEmailScore(email: string): number {
  return isDisposableEmail(email) ? 25 : 0;
}
